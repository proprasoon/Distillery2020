...
import com.mentor.impl.LiquorVehicleAccidentCaseImpl;
import com.mentor.utility.Constants;

public class LiquorVehicleAccidentCaseAction {

	LiquorVehicleAccidentCaseImpl impl = new LiquorVehicleAccidentCaseImpl();
	...
	private long total_bottles;
	
	public boolean isScanFlag() {
		return scanFlag;
	}
	public long getTotal_bottles() {
		return total_bottles;
	}
	public void setTotal_bottles(long total_bottles) {
	...
	public void pdf31() {
		...
		try {
			...
			String recordFile = this.gatepass_no+"inspection.pdf";
	...
	public void view(ActionEvent e){
		...
		LiquorVehicleAccidentCaseDT dt = (LiquorVehicleAccidentCaseDT) this.display_list.get(uiTable.getRowIndex());
		...
		System.out.println("dt.getVch_finalize()=="+dt.getVch_finalize()+" radio=="+this.radio);
		if(dt.getVch_finalize().equalsIgnoreCase("N") && this.radio.equalsIgnoreCase("N")){
		this.scanFlag=true;
		...
		this.total_bottles=dt.getTotal_bottles();
	...
	public void scanUpload(ActionEvent e){
		...
		this.tableFlag = true;
		this.total_bottles=dt.getTotal_bottles();
		System.out.println("dt.getTotal_bottles()==="+dt.getTotal_bottles());
		if(this.total_bottles>0){
		this.getVal = impl.getExcelData(this);
		}
	}
