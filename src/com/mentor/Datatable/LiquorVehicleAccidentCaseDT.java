...
public class LiquorVehicleAccidentCaseDT {
	...
	private String gatepass_type, vch_from, vch_finalize;
	...
	private boolean finalizePrint,printFlag, verify_flg, returnpdfFlag;
    private long total_bottles;

	
	public boolean isReturnpdfFlag() {
		return returnpdfFlag;
	}
	public void setReturnpdfFlag(boolean returnpdfFlag) {
		this.returnpdfFlag = returnpdfFlag;
	}
