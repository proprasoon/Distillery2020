	...
	boolean flg=false;
	 try {
		...
		query=
				...
				"  star_exp_house_cert_pdf, gstin_no, distillery_id, created_dt,user1_nm, status, type, checked)  "+
				"	VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?,?, ?, ? ,? ) " ;
				...
				pstmt.setString(17, act.getRadio());
				pstmt.setBoolean(18, act.isCheckbox());
