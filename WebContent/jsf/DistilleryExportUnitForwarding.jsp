   ...
   <div align="center">
			...
			<rich:spacer height="10px"></rich:spacer>
					...
					<rich:dataTable id="table22" rows="15" var="list22"
						...
						<rich:column align="center">
							...
							<h:outputText value="#{list22.type}">
							</h:outputText>
						</rich:column>
	...
	<rich:spacer height="20px"></rich:spacer>
             ...
             <rich:calendar value = "#{distilleryExportUnitForwardingAction.export_certificate_issue_date}" readonly="true">
					...
					<h:panelGroup rendered="#{(distilleryExportUnitForwardingAction.type eq 'SPIRIT' and distilleryExportUnitForwardingAction.checked) or distilleryExportUnitForwardingAction.type eq 'IMFL'}">
					<div class= "row"> 
					<div align="center" >
