...
<h:inputHidden value="#{dist_exp_uni_reg_action.hidden}"></h:inputHidden>
			<div class="panel panel-default">
				...
				<div class="panel-body">
					...
					<div align="center">
					 <h:selectOneRadio value="#{dist_exp_uni_reg_action.radio}"
					 onchange="this.form.submit();">
					 <f:selectItem itemLabel="IMFL" itemValue="IMFL"/>
					 <f:selectItem itemLabel="SPIRIT" itemValue="SPIRIT"/>
					 </h:selectOneRadio>
					</div>
					<div class="row">
	...
	<rich:spacer height="20px"></rich:spacer>
             ...
             <rich:calendar value = "#{dist_exp_uni_reg_action.export_certificate_issue_date}">
					...
					<div>
					<h:selectBooleanCheckbox value="#{dist_exp_uni_reg_action.checkbox}" rendered="#{dist_exp_uni_reg_action.radio eq 'SPIRIT'}"
					onchange="this.form.submit();">
					
					</h:selectBooleanCheckbox>
					<h:outputText value="  Whether bottled spirit is to be imported" rendered="#{dist_exp_uni_reg_action.radio eq 'SPIRIT'}"></h:outputText>
					</div>
					<div class= "row">				
						<rich:spacer height="20px"/>
					</div>
					<h:panelGroup rendered="#{(dist_exp_uni_reg_action.checkbox and dist_exp_uni_reg_action.radio eq 'SPIRIT') or dist_exp_uni_reg_action.radio eq 'IMFL'}"> 
					<div class= "row"> 
