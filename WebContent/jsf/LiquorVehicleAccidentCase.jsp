       ...
       <h:inputHidden value="#{liquorVehicleAccidentCaseAction.hidden}" />
					...
					<rich:dataTable id="table22" rows="15" var="list"
						...
						<rich:column align="center" rendered="#{liquorVehicleAccidentCaseAction.radio eq 'S'}">
							...
							rendered="#{list.verify_flg and list.returnpdfFlag==false}" styleClass="btn btn-primary btn-sm"></h:commandButton>
							<h:outputLink styleClass="outputLinkEx"
												value="/doc/ExciseUp/WholeSale/pdf//#{list.gatepass_no}_return.pdf"
												target="_blank">
												<h:outputText styleClass="outputText" id="text22"
													value="View Return Gatepass" rendered="#{list.returnpdfFlag}"
													style="color: blue; font-family: serif; font-size: 12pt"></h:outputText>
											</h:outputLink>
							 ...
							 <div >
							   <TABLE align="center" class="table1">
							    ...
							    <TR style="margin-top: 10px;">
							     ...
							     <TD style="text-align: right; width:200px;"><h:outputText value="Accident Location District:"></h:outputText></TD>
							      <TD style="text-align: right; width:200px;"><h:inputText value="#{liquorVehicleAccidentCaseAction.accident_district_name}" styleClass="inputtext"  readonly="true">
						       
							     </h:inputText> </TD >
							      <TD  style="text-align: right; width:150px;"><h:outputText value="Accident  Date :"></h:outputText></TD>
							      <TD  style="text-align: right; width:150px;"><h:inputText value="#{liquorVehicleAccidentCaseAction.accident_date}" styleClass="inputtext"  readonly="true"></h:inputText > </TD>
							    </TR>
				 ...
				 <div class="row">   
				  <rich:spacer height="30"></rich:spacer>
							   ...
							   <TABLE align="center" class="table1">
							    <TR style="margin: 5px;">
							     ...
							     <TD style="text-align: right"><h:outputText value="Licensee Name:"></h:outputText></TD>
							      ...
							      <TD  style="text-align: right; width:200px;"><h:outputText value="Licensee Address :"></h:outputText></TD>
							    ...
							    <TD style="text-align: right"><h:outputText value="Vehicle Agency Name and Address :"></h:outputText></TD>
							      <TD><h:inputTextarea value="#{liquorVehicleAccidentCaseAction.agency_name}"></h:inputTextarea> </TD>
							       <TD  style="text-align: right; width:200px;"><h:outputText value="New Validity Date :"></h:outputText>
							...
							<a4j:outputPanel rendered="true">
							 ...
							 <h:panelGroup rendered="#{liquorVehicleAccidentCaseAction.scanFlag and liquorVehicleAccidentCaseAction.radio eq 'N'}">
							 <div class="main">
						...
						<tr align="left">
							<td style="FONT-WEIGHT: bold; color: Green; width: 348px;"
								align="left"><h:outputText
									rendered="#{liquorVehicleAccidentCaseAction.gatePassFlag}"
									value="Upload the csv containing boxes which are ready to dispatch at the destination :"
					...
					<rich:dataTable id="table23"  var="list22"
						...
						<rich:column align="center">
							...
							<h:inputText value="#{list22.prcced_dispatch_box}" readonly="true" style="width: 90px;">
							</h:inputText>
						</rich:column>
						...
						<rich:column align="center">
							...
							<h:inputText value="#{list22.prcced_dispatch_bottle}" readonly="true" style="width: 90px;">
							</h:inputText>
						</rich:column>
							   ...
							   <TABLE align="center" class="table1">
							    ...
							    <TR style="margin-top: 10px;">
							     ...
							     <TD style="text-align: right;"><h:outputText value="Vehicle No:">
							      ...
							      <TD style="max-width:150px;"><h:inputText value="#{liquorVehicleAccidentCaseAction.return_vehicle_no}" styleClass="inputtext">
						       
							     </h:inputText> </TD>
							      <TD style="text-align: right; width:200px;"><h:outputText value="Driver Name :"></h:outputText>
							       <h:outputText value="*" style="color:red;"></h:outputText></TD>
							    ...
							    <TD style="text-align: right"><h:outputText value="Vehicle Agency Name and Address :"></h:outputText>
							     <h:outputText value="*" style="color:red;"></h:outputText></TD>
							      ...
							      <TD style="text-align: right; width:200px;"><h:outputText value=" Validity Date :"></h:outputText>
							       <h:outputText value="*" style="color:red;"></h:outputText></TD>
							    ...
							    <TR style="height: 20px;"></TR>
							     ...
							     <TD colspan="6"><h:commandButton value="Save" action="#{liquorVehicleAccidentCaseAction.printReturn}"></h:commandButton>
